...
export default function NextFight() {
  ...
  return (
    <section id="next-fight" className="py-20 px-4 sm:px-6 lg:px-8 bg-black">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-bold text-ice text-center mb-4">PRÓXIMO COMBATE</h2>
