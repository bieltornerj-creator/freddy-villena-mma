          ...
          <div className="grid md:grid-cols-2 gap-8 p-8">
            ...
            >
              ...
              <div className="flex gap-2 justify-center">
                <motion.button
                  onClick={prevImage}
                  className="p-2 bg-gray-800 hover:bg-gray-700 rounded-lg transition-colors text-ice font-bold"
            ...
            >
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <input
                    ...
                    className="flex-1 px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-light text-center"
                  />
                  <button
              ...
              <div className="py-4 border-t border-b border-ice/20">
                <p className="text-gray-400 mb-1">Precio unitario:</p>
              ...
              <motion.button
                ...
                disabled={loading}
                className="w-full btn-ice disabled:opacity-50 disabled:cursor-not-allowed"
