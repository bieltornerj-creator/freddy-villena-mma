  ...
  return (
    <div className="min-h-screen bg-dark p-8">
      <div className="container-custom max-w-2xl">
        <h1 className="text-4xl font-bold text-ice mb-8 text-center">Seguimiento de Pedido</h1>

        <div className="bg-gray-900 p-8 rounded-lg border border-ice/20 mb-8">
          <form onSubmit={handleTracking} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-black border border-ice/20 rounded-lg text-light"
              />
            </div>
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-ice text-dark font-bold rounded-lg hover:bg-cyan-400 transition-colors disabled:opacity-50"
            >
        ...
        {trackingInfo && (
          <div className="bg-gray-900 p-8 rounded-lg border border-ice/20">
            <h2 className="text-2xl font-bold text-ice mb-6">Estado del Pedido</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4 border-t border-ice/20">
                <p className="text-ice font-semibold">{trackingInfo.estimate}</p>
              </div>
            </div>

            {/* Timeline */}
            <div className="mt-8 space-y-4">
              <h3 className="text-ice font-bold mb-4">Historial</h3>
              <div className="space-y-3">
                <div className="flex gap-4">
                  <div className="w-3 h-3 bg-ice rounded-full mt-2 flex-shrink-0" />
                  <div>
